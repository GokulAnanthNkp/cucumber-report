$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("file:src/main/resources/config/StoryID-ListFunctionalityTest.feature");
formatter.feature({
